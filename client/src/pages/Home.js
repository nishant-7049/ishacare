      ...
      <div className='body'>
        ...
        <div className='therapists container'>
          ...
          <p className='therapists-para con-para'>
            ...
            ipsum recusandae, dolorem quas doloremque enim hic repellendus nulla
            ex perferendis fugit fuga, reprehenderit consequatur!
          </p>
          <button className='arrow-button prev-button'>
            <img
              className='arrow-img prev-img'
          ...
          <div className='the-container '>
            <div className='the-item '>
              <div className='the-card'>
                <div className='the-card-con'>
                  <div className='the-details'>
                    <h3 className='the-name card-head'>Dr. 1Name Surname</h3>
                    <span className='the-exp'>
                      <img
                        src='/images/therapists-experience.png'
                        alt=''
                        className='exp-logo'
                      />
                      <p className='exp-text card-text'>
                        10+ Years of experience
                      </p>
                    </span>
                    <span className='the-edu'>
                      <img
                        src='/images/therapists-school.png'
                        alt=''
                        className='edu-logo'
                      />
                      <p className='edu-text card-text'>
                        College of Something something
                      </p>
                    </span>
                  </div>
                  <img src='/images/doc1.png' alt='' className='the-img' />
                </div>
              </div>
            </div>
            <div className='the-item'>
              <div className='the-card'>
                <div className='the-card-con'>
                  <div className='the-details'>
                    <h3 className='the-name card-head'>Dr. 2Name Surname</h3>
                    <span className='the-exp'>
                      <img
                        src='/images/therapists-experience.png'
                        alt=''
                  ...
                  <img src='/images/doc2.png' alt='' className='the-img' />
                </div>
              </div>
            </div>
            <div className='the-item '>
              <div className='the-card'>
                <div className='the-card-con'>
                  <div className='the-details'>
                    <h3 className='the-name card-head'>Dr. 3Name Surname</h3>
                    <span className='the-exp'>
                      <img
                        src='/images/therapists-experience.png'
                        alt=''
            ...
            <div className='the-item '>
              <div className='the-card'>
                <div className='the-card-con'>
                  <div className='the-details'>
                    <h3 className='the-name card-head'>Dr. 4Name Surname</h3>
                    <span className='the-exp'>
                      <img
                        src='/images/therapists-experience.png'
                        alt=''
