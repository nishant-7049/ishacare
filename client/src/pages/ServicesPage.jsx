...
const data = [
  ...
  },
  {
    ...
    p2: `Our experienced instructors bring a wealth of knowledge and expertise, making each session unique and enjoyable. Our yoga program is a great way to reduce stress, improve mental health, and enhance physical well-being.`,
  },
  {
    id: 2,
    topic: "Lifestyle Wellness Program",
    img: "/images/service/img (3).png",
    p1: `Our Lifestyle Wellness Program is a comprehensive, personalized approach to achieving optimal health and wellness. We offer a range of services to help you achieve your goals, including:
    `,
    list: [
  ...
  },
  {
    ...
    img: "/images/service/img (2).png",
    p1: `We offer a comprehensive employee wellness program that includes health education and exercise sessions to empower your staff to prevent and address a range of occupational health problems. Our program is designed to promote physical and mental well-being, increase productivity, and reduce absenteeism.
    `,
    list: [
  ...
  },
  {
    ...
    img: "/images/service/img (3).png",
    p1: `We are excited to announce that our new wellness resort project is coming soon! 
    `,
    list: [
